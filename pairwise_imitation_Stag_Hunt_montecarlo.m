...
% The evolution of play under Revision protocol 1 (PRI) 
% is stored in the array Action1
...
% The agents' payoffs under Revision protocol 1 (PRI)
% are stored in the array Payoff1
...
for round=2:N_rounds
    ...
    for i=1:N
        ...
        opponent=mod(i,2)*(2)+i-1;
            ...
            % If agent i makes a mistake, she selects the action
            % that is NOT prescribed by the revision protocol
            if rand()<p_error
...
% If Player i played Stag at time t under protocol X, we have:
% ActionX(i,t)=1.
