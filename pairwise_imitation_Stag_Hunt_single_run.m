...
% - 1/2 of the population plays Stag and
%   1/2 of the population plays Hare at round 1:
%   Action1 = [zeros(1,N/2) ones(1,N/2)];
%   Action1 = Action1(randperm(numel(Action1)));

round=1; % set first round of play

% The agents' payoffs under Revision protocol 1 (PRI) are described 
% by the array Payoff1
...
% Actionx(i,t)=1
% So the proportions of players who played Stag at  t are:
